...
export default function ManageInProgress(props) {
  ...
  const getAllEmployeeLeaveHistoryData = (pageNumber, pageSize) => {
    getAllEmployeeLeaveRequestHistory(pageNumber, pageSize).then((res: any) => {
  ...
  const columns: Column[] = [
    ...
    },
    {
      ...
      label: "",
      render: (value) => (
        <Button variant="text" onClick={() => handleClickViewDetails(value)}>
          Detail
        </Button>
      ),
    },
  ...
  return (
    <div>
      ...
      <Container maxWidth="lg">
        <Card>
          <Typography variant="h6" margin="10px 0 0 20px">

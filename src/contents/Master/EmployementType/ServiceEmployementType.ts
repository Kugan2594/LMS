...
const getAllEmployementType = () => {
  return new Promise((resolve, reject) => {
    api("get", "lm-web", null, `/employementType`, "", "", "")
      .then((response: any) => {
...
export { deleteEmployementType, getAllEmployementType,createEmployementType,updateEmployementType };
